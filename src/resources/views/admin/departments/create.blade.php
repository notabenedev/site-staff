...
@section("page-title", config("site-staff.siteDepartmentName")." - создать")

@section('header-title', config("site-staff.siteDepartmentName")." - создать")
...
@section('admin')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                @php($route = empty($department) ? route("admin.departments.store") : route("admin.departments.store-child", ["department" => $department]))
